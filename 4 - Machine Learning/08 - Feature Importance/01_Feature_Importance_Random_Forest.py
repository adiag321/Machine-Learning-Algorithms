...
###################################
def rf_feature_importance(X, y, X_train, y_train, X_test, y_test):
        '''
...
model_rf, rf_feat_importance_df = rf_feature_importance(X, y, X_train, y_train, X_test, y_test)
# Exporting feature importances
#rf_feat_importance_df.to_csv("feature_importance_gini.csv", index=False)
