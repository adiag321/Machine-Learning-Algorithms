...
def gradient_boosting_model(X_train, X_test, y_train, y_test, feature_names=None):
    """
    Parameters:
    -----------
    X_train : array-like
    ...
    cv_scores = cross_val_score(gb_clf, X_train, y_train, cv=StratifiedKFold(n_splits=5), scoring='f1')
    ...
    feature_imp = gb_clf.feature_importances_
    top_n = 10
...
gradient_boosting_model(X_train_scaled, X_test_scaled, y_train, y_test, feature_names=feature_names)