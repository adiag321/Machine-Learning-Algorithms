...
def lightgbm_model(X_train, X_test, y_train, y_test, feature_names=None):
    """
    Parameters:
    -----------
    X_train : array-like
    ...
    print_metrics : bool, default=True
        Whether to print metrics summary
    ...
    y_pred_proba_test = lgb_clf.predict_proba(X_test)[:, 1]
    ...
    cv_scores = cross_val_score(lgb_clf, X_train, y_train, cv=StratifiedKFold(n_splits=5), scoring='f1')
...
lightgbm_model(X_train_scaled, X_test_scaled, y_train, y_test, feature_names=feature_names)