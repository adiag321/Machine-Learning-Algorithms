...
exp_name = 'Model_Comparison_Sweep1'
experiment_name_for_predictions = 'Model_Comparison_Sweep1'
champion_model_name = 'Iris_Sweep_Champion'

def apply_mlflow(uri, exp_name, model_configs, acc_threshold, champion_model_name):
    mlflow.set_tracking_uri(uri) # Using local sqlite for immediate testing
    ...
    # 1. Connect to your tracking server and get exp name
    mlflow.set_tracking_uri(uri) 
    experiment_name = experiment_name_for_predictions
    ...
    df_runs = mlflow.search_runs(
        ...
        filter_string="metrics.accuracy > acc_threshold",                         # Optional: Only consider decent models
...
def mlflow_make_predicitons(champion_model_name, pred_data):
    # ---------------------------------------------------------
    ...
    model_uri = f"models:/{champion_model_name}@champion"
...
## Calling the predicitons funciton 
mlflow_make_predicitons(champion_model_name = champion_model_name, pred_data = X_test)